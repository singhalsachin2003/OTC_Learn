...
[Open in the app](/OTC_Learn/) · [Alternative Underlyings](/OTC_Learn/category/alt/) · intermediate
...
- **Basis** — The difference between a future’s price and the spot price of the underlying it references.
- **Cash and carry** — Buying the underlying and selling the future against it to capture the basis until expiry.
- **Cost of carry** — Interest, storage and insurance less any income — what the basis should equal in an orthodox market.
- **Annualised basis** — The spread scaled to a yearly rate, which is the only form in which two contracts are comparable.
- **Reverse cash and carry** — The mirror trade — short the asset, long the future — which requires borrowing the underlying.
- **Convergence** — The narrowing of the basis to zero at expiry, which is what makes the captured spread a return.
...
- [Perpetual Swap](/OTC_Learn/product/perp/) — A future with no expiry, held to spot by a payment
