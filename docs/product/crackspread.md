...
- **Crack spread** — The difference between the value of refined products and the cost of the crude used to make them.
- **3-2-1 ratio** — The standard bundle of three barrels of crude against two of gasoline and one of distillate.
- **Distillate** — The middle-distillate product group covering diesel and heating oil, the third leg of the 3-2-1.
- **Reference index** — The published price each leg settles against, one for crude and one for each refined product.
- **Settlement period** — The month or other window over which each leg’s index is observed and the spread is calculated.
- **Quality basis** — The gap between the index grade and the crude or products a particular refinery actually handles.
