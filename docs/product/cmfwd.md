...
- **Contract price** — The price agreed today that the buyer will pay per unit on the delivery date.
- **Grade specification** — The quality standard the delivered commodity must meet for the seller to have performed.
- **Delivery point** — The named place where the goods change hands, which fixes who bears freight and where risk passes.
- **Delivery date** — The agreed date, or window, on which payment is made and the commodity is handed over.
- **Physical settlement** — Settlement by delivering the actual goods rather than paying a cash difference.
- **Cost of carry** — The storage, insurance and financing cost of holding a commodity until delivery, which shapes the forward price.
