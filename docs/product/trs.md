...
- **Reference asset** — The bond, loan or portfolio whose economics the swap passes across, held throughout by the payer.
- **Total return receiver** — The side taking the asset’s income, gains and losses in exchange for paying the financing leg.
- **Financing leg** — The floating payment — typically SOFR or €STR plus a spread — that buys the exposure.
- **Valuation date** — A scheduled date on which the asset is remarked so accrued gains or losses are settled in cash.
- **Haircut** — The portion of the exposure that must be covered by collateral, which fixes how much leverage the trade carries.
- **Independent amount** — The collateral posted at inception, before any variation margin starts moving with the mark.
