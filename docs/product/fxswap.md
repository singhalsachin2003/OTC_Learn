...
permalink: /product/fxswap/
---

# FX Swap

*Exchange currencies now and reverse it later*
...
## Funding a euro bond purchase for three months
...
- **Near leg** — The first exchange, usually at or close to the spot rate and the spot date.
- **Far leg** — The reversing exchange on the later value date, struck at the forward rate agreed at inception.
- **Swap points** — The difference between the far and near rates, which is the price of the swap and reflects the interest differential.
- **Tom-next** — A one-day swap rolling a position from tomorrow’s value date to the next business day.
- **Value date** — A date on which one of the two legs delivers; every FX swap has two of them.
- **Cross-currency swap** — A longer-dated relative that also exchanges interest payments over its life, which an FX swap does not.
