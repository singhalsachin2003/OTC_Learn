...
[Open in the app](/OTC_Learn/) · [Case Studies](/OTC_Learn/category/cases/) · intermediate
...
- **Segregation of duties** — Keeping trading, confirmation and settlement in separate hands so no one person can both trade and record.
- **Error account** — An account for correcting mistaken bookings, and here the place concealed losses were parked.
- **Short straddle** — Selling a call and a put at the same strike: premium now, unbounded loss if the market moves far.
- **Index arbitrage** — Trading the same index future on two exchanges for a small price difference, with little directional risk.
- **Reconciliation** — Checking the firm’s records against the exchange’s and the cash actually paid — the control that was absent.
- **Operational risk** — Loss from failed processes, people or systems, as distinct from market or credit risk.
...
- [Execution and Reporting](/OTC_Learn/product/execution/) — How a trade gets done, and who has to know about it
