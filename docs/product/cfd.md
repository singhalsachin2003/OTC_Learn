...
permalink: /product/cfd/
---

# Contract for Difference

*Cash-settled exposure to a price move*
...
[Open in the app](/OTC_Learn/) · [Equity](/OTC_Learn/category/equity/) · foundational
...
## A leveraged long, held for three weeks
...
- **Margin** — The cash posted to open and maintain a position, a fraction of its full value.
- **Leverage** — The ratio of position value to margin posted, which magnifies gains and losses alike.
- **Overnight financing** — The daily charge for funding the full value of a long position, accruing for as long as it is held.
- **Spread** — The gap between the dealer’s buy and sell prices, paid on entry and exit of every trade.
- **Margin close-out** — The dealer’s closing of positions once account equity falls below a set fraction of required margin.
- **Dividend adjustment** — A cash credit to long positions and debit to short ones when the underlying share goes ex-dividend.
